    ...
    <div className='text-center px-4 md:px-10'>
      ...
      <div className='md:my-5 my-3 flex flex-col md:flex-row lg:gap-6 md:gap-4 gap-2 items-center bg-white p-6 md:p-10 rounded-3xl'>
        ...
        <div className='text-left flex-1'>
          ...
          <p className="flex items-center pb-3 border-b border-gray-300 border-dashed gap-1">
            <FaRegRegistered /> Reg No: {doctor.registrationNumber}
          </p>

          {/* Availability */}
          <div className='flex items-center my-2 md:gap-3 gap-1.5'>
            <p>Availability:</p>
          ...
          {/* Consultation Fee */}
          <div className='flex flex-col md:flex-row items-center my-2 gap-2 md:gap-3'>
      ...
      <div className='my-5 bg-white p-5 md:p-10 rounded-2xl'>
        <h1 className='text-2xl md:text-3xl font-bold border-b border-gray-300 border-dashed pb-2'>Book an Appointment</h1>
        <div className='flex flex-row justify-between items-start md:items-center my-4 gap-2'>
          <p>Availability</p>
